const translations = {
  ar: {
    ...
    'hero.sub': 'طالب ماستر 1 إعلام آلي بجامعة أحمد دراية — أدرار، الجزائر. أبني تطبيقات موبايل بـ Flutter وتطبيقات سطح المكتب بـ WPF، وأدير خدمات نشر التطبيقات والتجارة الرقمية.',
    'hero.cta.projects': 'شاهد المشاريع',
    'hero.cta.contact': 'تواصل معي',
    'hero.meta.location': '📍 أدرار، الجزائر',
    'hero.meta.education': '🎓 ماستر 1 — إعلام آلي',
    'hero.meta.age': '🕑 21 سنة',
    ...
    'about.education.degree1': 'ماستر 1، إعلام آلي (حاليًا)',
    'about.education.degree2': 'ليسانس، إعلام آلي — نفس الجامعة',
